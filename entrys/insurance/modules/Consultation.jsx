        ...
        if(this.state.data!==undefined&&this.state.data!==null) {
            ...
            switch (this.state.nav) {
                case undefined:
                    container =
                        <div>
                            <div className="detail" style={{padding:'0 12em 3em 12em'}}>
                                ...
                                <div>
                                    ...
                                    {SyncStore.getNote() ?
                                        ...
                                        <input className='tgl tgl-flip' id='cb5' type='checkbox'/>
                                            <label style={{fontSize:'11px',lineHeight:'36px'}} id='lab5'onClick={this.setDataTg} className='tgl-btn' data-tg='全部'data-tg-off='全部' data-tg-on='只看自己' htmlFor='cb5'></label>
                                        </span>
                                        :null}
