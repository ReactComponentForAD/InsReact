                            ...
                            <div style={{padding:'0 5em 0 5em'}}>
                                <div className="col-md-8 banner-left" style={{width:'85%',paddingLeft: '8%',paddingTop:'10px'}}>
                                    <div className="reservation">
                                        <ul>
                                            <li  className="span1_of_1 desti" style={{width:'11em'}}>
                                                <h4>产品名:</h4>
                                                <div className="book_date">
                                                    <form>
                                                        <input type="text" onChange={this.onSaveInput.bind(this)} className="companyclass"/>
                                                    </form>
                                                </div>
                                            </li>
                                            <li className="span1_of_1 left " style={{paddingLeft: '1.2em'}}>
                                                <h4>公司选择:</h4>
                                                <div className="section_room" >
                                                    <select id="company" onChange={this.getSelectCompany} className="companyclass">
                                            ...
                                            <li className="span1_of_1 right "  >
                                                <h4>险种类型:</h4>
                                                <div className="section_room">
                                                    <select onChange={this.getSelectLifeInsuranceType}id="lifeInsuranceType" style={{width: '151px',marginLeft:'1.2em',height:'25px'}} >
                                            ...
                                            <li className="span1_of_3" style={{ paddingRight: '10em',marginTop: '-5px',float:'right'}}>
                                                <div className="date_btn">
                                                    <form>
                                                        <input className="search" style={{borderRadius:'3px',height:'2em',marginTop: '19px',background:'gray'}}onClick={this.getLimitInsurancesList} value="查询" />
                                                    </form>
                                                </div>
                                            </li>
                                ...
                                <div className="col-md-8 banner-left" onClick={this.slidePage.bind(this,'right')} style={{width:'120px',textAlign: 'center',cursor:'pointer'}}>
                                            <p style={{ color: '#FFFFFF', fontSize: '16px',border: 'none',borderRadius:' 3px', height: '2em',marginTop: '19px', background: 'gray'}}>定制产品</p>
                                </div>
                            </div>
                            <div className="clearfix"></div>
                        </div>
                                ...
                                <div className="product-grids">
                                    <div className="basic" style={{width:'98%'}}>
                                        ...
                                        <div className="value" style={{background:'rgba(17, 17, 17, 0.6)'}}>
                                            <p>计划保费:</p>
                                            <input type="text" style={{width:'25%',height: '25px',margin:'0 auto',textAlign:'center', fontSize:'20px'}}className="companyclass" required=""/>
                                        </div>
