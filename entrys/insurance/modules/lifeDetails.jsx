        ...
        return <div className="basic" style={{width:'98%'}}>
            ...
            <ul style={{height: 'auto'}}>
                <div className="proIntro">
                    <h3 style={{color: '#1c6d40',fontFamily: 'Nunito sans-serif',paddingRight:'80%'}}>产品介绍</h3>
                    <hr style={{borderTop: '5px solid #1c6d40',width: '86%',marginLeft:'7%'}}/>
                ...
                <div className="lyys">
                    <h3 style={{color: '#1c6d40',fontFamily: 'Nunito sans-serif',paddingRight:'80%'}}>利益测算</h3>
                    <hr style={{borderTop: '5px solid #1c6d40',width: '86%',marginLeft:'7%'}}/>
                    <table style={{border:'0', cellPadding:"0", cellSpacing:"0", width: '70%',marginLeft:'15%', borderBottom: '2px solid #ccc'}}>
                        ...
                        <tr>
                            ...
                            <td  >
                                <input onClick={this.measure} className="search" style={{width: '100%',height: '90%',borderRadius: '7px',background:'#1c6d40',marginBottom: '15px'}}type="button" value="利益测算" id="showGainDemo"   />
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div className="kfjx">
                    <h3 style={{color: '#1c6d40',fontFamily: 'Nunito sans-serif',paddingRight:'80%'}}>可附加险种</h3>
                    <hr style={{borderTop: '5px solid #1c6d40',width: '86%',marginLeft:'7%'}}/>
                ...
                <div className="bzfw">
                    <h3 style={{color: '#1c6d40',fontFamily: 'Nunito sans-serif',paddingRight:'80%'}}>保障范围</h3>
                    <hr style={{borderTop: '5px solid #1c6d40',width: '86%',marginLeft:'7%'}}/>
                    <div className="bznr">
                ...
                <div className="jlsm">
                    <h3 style={{color: '#1c6d40',fontFamily: 'Nunito sans-serif',paddingRight:'80%'}}>举例说明</h3>
                    <hr style={{borderTop: '5px solid #1c6d40',width: '86%',marginLeft:'7%'}}/>
                    <div className="lizi" id="example"></div>

                </div>
                <div className="shfw">
                    <h3 style={{color: '#1c6d40',fontFamily: 'Nunito sans-serif',paddingRight:'80%'}}>售后服务</h3>
                    <hr style={{borderTop: '5px solid #1c6d40',width: '86%',marginLeft:'7%'}}/>
