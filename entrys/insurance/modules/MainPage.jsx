            ...
            mainContent =
                <div className='MainPage'>
                        ...
                        <div className='row'>
                            <Link to={window.App.getAppRoute() + "/lifeInsurance"}>
                                <div className="col-sm-4" style={{padding: '20px', paddingRight: '0px'}}>
                                    <a className="featured-grid" style={{
                                        height: '330px',
                                        border: '#e1e1e1 1px solid',
                                        boxShadow: '0px 3px 11px #737373',
                                        backgroundImage: 'url(' + App.getResourceDeployPrefix() + '/images/image_6.png)'
                                    }}>
                                        <div className="desc">
                                            <h3>寿险</h3>
                            ...
                            <div className="col-sm-4" style={{padding: '20px'}}>
                                <div style={{
                                    ...
                                    boxShadow: 'rgb(115, 115, 115) 0px 3px 11px',
                                    height: '330px',
                                    backgroundColor: '#b7e2d9'
                                }}>
                            ...
                            <Link to={window.App.getAppRoute() + "/carInsurance"}>
                                <div className="col-sm-4" style={{padding: '20px', paddingLeft: '0px'}}>
                                    <a className="featured-grid featured-grid-2" style={{
                                        height: '330px',
                                        border: '#e1e1e1 1px solid',
                                        boxShadow: '0px 3px 11px #737373',
                                        backgroundImage: 'url(' + App.getResourceDeployPrefix() + '/images/image_2.png)'
                                    }}>
                                        <div className="desc">
                                            <h3>车险</h3>
                    ...
                    <div className="footer" style={{
                        width: '100%',
                        height: '15%',
                        background: 'url(' + App.getResourceDeployPrefix() + '/images/footer.png) no-repeat',
                        backgroundSize: '100%'
                    }}>
                        <Footer/>
                    </div>
